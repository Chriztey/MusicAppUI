...
import com.chris.musicappui.MainViewModel
import com.chris.musicappui.R
import com.chris.musicappui.Screen
import com.chris.musicappui.screensInBottom
import com.chris.musicappui.screensInDrawer
...
fun MainView() {
    ...
    // these 3 allow us to find out on which "View" we currently are
                ...
                TopAppBar(title = { Text(text = title.value) },
                    actions = {
                              IconButton(onClick = { scope.launch {
                                  if (modalSheetState.isVisible) modalSheetState.hide() else
